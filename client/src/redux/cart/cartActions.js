...
export const addToCart = (product) => {
    return async (dispatch, getState) => {
        ...
        try {
            const add = await userService.addToCart(productId);
...
export const removeFromCart = (product) => {
    return async (dispatch, getState) => {
        ...
        try {
            const remove = await userService.removeFromCart(productId);
            
            dispatch({type: REMOVE_FROM_CART, payload: product});
        } catch (error) {
            console.error("Could not remove from Cart:", error.message);
        }
...
export const removeCartItem = (product) => {
    return async (dispatch, getState) => {
        ...
        try {
            const removeItem = await userService.deleteCartItem(productId);
...
export const fetchCart = (token) => {
    return async (dispatch) => {
        try {
            ...
            const data = await userService.getCartFromDb();
...
export const saveForLater = (product) => {
    return async (dispatch, getState) => {
        ...
        try {
            const savedForLater = await userService.saveItemForLater(productId);
